...
<body>
    ...
    <main class="container-lg py-4">
        <!-- Hero -->
        <section class="bg-light rounded-4 shadow-sm p-4 p-md-5 mb-5">
            <div class="row g-5 align-items-center">
                    ...
                    <div class="row gy-3 mt-4">
                        ...
                        <div class="col-6 col-sm-4">
                            <div class="d-flex flex-column">
                                ...
                                <a class="fw-semibold" href="https://wa.me/6281317011839">0813‑1701‑1839</a>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4">
                            <div class="d-flex flex-column">
                                <small class="text-uppercase text-muted">Email</small>
                                <a class="fw-semibold" href="mailto:furnitureintime@gmail.com">furnitureintime@gmail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="ratio ratio-16x9 rounded-3 overflow-hidden shadow-sm">
                        <img src="assets/img/furniture-img.png" alt="Intime Furniture" class="object-fit-cover w-100 h-100" />
                    </div>
                </div>
            </div>
        </section>
            ...
            <aside class="col-lg-4">
                <div class="card shadow-sm mb-3">
                    <div class="card-body">
                        ...
                        <p class="mb-1"><i class="fas fa-map-marker-alt me-2 text-primary"></i>Blk. Singkuk No.22B, Pagar Kuning, Kec. Limo, Kota Depok, Jawa Barat 16515</p>
                        <p class="mb-1"><i class="fas fa-phone me-2 text-primary"></i><a href="https://wa.me/6281317011839">0813‑1701‑1839</a></p>
                        <p class="mb-3"><i class="fas fa-envelope me-2 text-primary"></i><a href="mailto:furnitureintime@gmail.com">furnitureintime@gmail.com</a></p>
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-0">
                        <iframe src="https://www.google.com/maps?q=Blk.%20Singkuk%20No.22B%20Pagar%20Kuning%20Limo%20Depok&output=embed" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </aside>
        </div>
